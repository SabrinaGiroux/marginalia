export function AddBookCard({ onClick }: { onClick: () => void }) {
  return (
    <li
      className="card flex flex-col h-full min-h-87.5 min-w-55 justify-center items-center gap-3 hover:cursor-pointer border-[#2a2a2a] p-4 hover:border-slate-600 "
      onClick={onClick}
    >
