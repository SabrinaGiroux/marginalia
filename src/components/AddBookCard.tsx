export function AddBookCard({ onClick }: { onClick: () => void }) {
  return (
    <li
      className="flex flex-col rounded-lg border-2 border-dashed border-[#3a3530] p-4 bg-[#1a1a1a] justify-center items-center gap-3  hover:border-[#c8a96e] hover:cursor-pointer transition duration-200"
      onClick={onClick}
    >
